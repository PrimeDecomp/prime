...
#include "MetroidPrime/CArchMsgParmInt32Int32String.hpp"
...
#include "MetroidPrime/CArchMsgParmString.hpp"
#include "MetroidPrime/CArchMsgParmUserInput.hpp"
#include "MetroidPrime/CArchitectureMessage.hpp"

class CIOWin;
namespace MakeMsg {
const CArchMsgParmString& GetParmDeleteIOWin(const CArchitectureMessage& msg);
...
const CArchMsgParmInt32Int32String& GetParmChangeIOWinPriority(const CArchitectureMessage& msg);
