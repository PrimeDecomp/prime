...
/* 801BE12C 001BB08C  A1 6D A3 8C */	lhz r11, lbl_805A8F4C@sda21(r13)
...
/* 801BF020 001BBF80  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 801BF16C 001BC0CC  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 801BF280 001BC1E0  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 801BF38C 001BC2EC  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 801BF418 001BC378  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 801BF5C0 001BC520  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 801BF5D4 001BC534  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 801BF644 001BC5A4  A0 8D A3 8C */	lhz r4, lbl_805A8F4C@sda21(r13)
...
/* 801BF884 001BC7E4  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
lbl_801BF8D4:
/* 801BF8D4 001BC834  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 801BFBFC 001BCB5C  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 801BFEB0 001BCE10  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 801C007C 001BCFDC  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
