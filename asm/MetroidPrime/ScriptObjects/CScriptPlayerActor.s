...
/* 801AA43C 001A739C  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 801AA48C 001A73EC  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
lbl_801AA4EC:
/* 801AA4EC 001A744C  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 801AA500 001A7460  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
lbl_801AB344:
/* 801AB344 001A82A4  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
/* 801AB348 001A82A8  B0 01 00 0C */	sth r0, 0xc(r1)
lbl_801AB34C:
/* 801AB34C 001A82AC  A0 61 00 0C */	lhz r3, 0xc(r1)
/* 801AB350 001A82B0  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 801AC160 001A90C0  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
