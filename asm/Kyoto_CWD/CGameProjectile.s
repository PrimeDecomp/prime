...
/* 800377E4 00034744  A9 02 C5 FA */	lha r8, lbl_805AE31A@sda21(r2)
/* 800377E8 00034748  38 A0 00 7F */	li r5, 0x7f
/* 800377EC 0003474C  81 42 C6 00 */	lwz r10, lbl_805AE320@sda21(r2)
...
/* 800378BC 0003481C  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 800378E0 00034840  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 80037A34 00034994  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 80037AC0 00034A20  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
lbl_80037B6C:
/* 80037B6C 00034ACC  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 80037BD8 00034B38  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 80037E84 00034DE4  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 8003829C 000351FC  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
lbl_80038390:
/* 80038390 000352F0  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 80038708 00035668  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 8003871C 0003567C  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 800389EC 0003594C  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 80038EA8 00035E08  48 2D AF 29 */	bl __ct__11CUnitVectorFRC9CVector3f
...
/* 80038FE0 00035F40  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 800390C8 00036028  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 800392B8 00036218  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 8003974C 000366AC  48 2D A6 85 */	bl __ct__11CUnitVectorFRC9CVector3f
...
lbl_80039834:
/* 80039834 00036794  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
lbl_80039974:
/* 80039974 000368D4  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 80039B28 00036A88  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 80039BB8 00036B18  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 80039C44 00036BA4  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 80039D10 00036C70  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 80039DCC 00036D2C  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 80039EFC 00036E5C  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
lbl_8003A158:
/* 8003A158 000370B8  38 6D A3 8C */	addi r3, r13, lbl_805A8F4C@sda21
lbl_8003A15C:
...
lbl_8003A1E0:
/* 8003A1E0 00037140  A0 0D A3 8C */	lhz r0, lbl_805A8F4C@sda21(r13)
...
/* 8003A718 00037678  A0 8D A3 8C */	lhz r4, lbl_805A8F4C@sda21(r13)
/* 8003A71C 0003767C  B0 8F 02 C2 */	sth r4, 0x2c2(r15)
/* 8003A720 00037680  A0 8D A3 8C */	lhz r4, lbl_805A8F4C@sda21(r13)
/* 8003A724 00037684  B0 8F 02 C4 */	sth r4, 0x2c4(r15)
/* 8003A728 00037688  A0 8D A3 8C */	lhz r4, lbl_805A8F4C@sda21(r13)
/* 8003A72C 0003768C  B0 8F 02 C6 */	sth r4, 0x2c6(r15)
/* 8003A730 00037690  A0 8D A3 8C */	lhz r4, lbl_805A8F4C@sda21(r13)
